...
<div class="form-floating" style="width: 30%; margin: 0 auto;">
    <h4 style="text-align: center">Enter your email address</h4>
      <input type="email" class="form-control" id="floatingInput" name="Manageremail" placeholder="name@example.com" > <!--attribute "password" goes through SignInServlet-->
...
<br>
    ...
    <div class="form-floating" style="width: 30%; margin: 0 auto;">
      ...
      <input type="password" class="form-control" id="floatingPassword" name="Managerpassword" placeholder="Password"> <!--attribute "password" goes through SignInServlet-->
    </div>
